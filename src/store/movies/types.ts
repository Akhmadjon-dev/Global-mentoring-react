...
export type TMovieGenres = [string]
export interface IMovieSuccessPayload {
    totalAmount: number;
    data: IMovie[];
    limit: number;
    offset: number;
...
export interface IMovieSuccess {
    ...
    payload: IMovieSuccessPayload
}

export type MovieDispatchTypes = IMovieLoading | IMovieError | IMovieSuccess;
